...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} HourClock2}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This module contains the definition of the specification \ensuremath{HC2}
 from the
 book.
\end{cpar}%
\end{lcom}%
...
This statement includes in the current module all the definitions and
 declarations from module \ensuremath{HourClock}, including the definitions
 of +
...
\end{lcom}%
\@pvspace{8.0pt}%
 \@x{ HCnxt2\@s{4.1} \.{\defeq}\@s{4.1} hr \.{'} \.{=} ( hr \.{\%} 12 ) \.{+}
 1}%
\@x{ HC2\@s{4.1} \.{\defeq}\@s{4.1} HCini \.{\land} {\Box} [ HCnxt2 ]_{ hr}}%
\@x{}\midbar\@xx{}%
\@x{ {\THEOREM}\@s{4.1} HC \.{\equiv} HC2}%
\begin{lcom}{8.2}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This theorem asserts that formulas \ensuremath{HC} and \ensuremath{HC2} are
 equivalent. The
 symbol \ensuremath{\.{\equiv}} , which can also be typed as
 \ensuremath{\.{\equiv}} , is typeset as an
