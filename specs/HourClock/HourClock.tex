...
\@x{ {\VARIABLE} hr}%
\@y{\@s{0}%
 Variable \ensuremath{hr} represents the display.
}%
\@xx{}%
\@x{ HCini\@s{1.75} \.{\defeq} hr \.{\in} ( 1 \.{\dotdot} 12 )}%
\@y{\@s{0}%
 Initially, \ensuremath{hr} can have any
}%
\@xx{}%
\@x{\@s{107.30}}%
\@y{\@s{0}%
...
\begin{lcom}{8.2}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The value of \ensuremath{hr} cycles from 1 through 12.
\end{cpar}%
\end{lcom}%
 \@x{\@s{12.29} hr \.{'} \.{=} {\IF} hr \.{\neq} 12 \.{\THEN} hr \.{+} 1
 \.{\ELSE} 1}%
