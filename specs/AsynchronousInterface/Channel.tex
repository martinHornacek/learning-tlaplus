...
\@x{ {\CONSTANT} Data}%
\@x{ {\VARIABLE} channel}%
 \@x{ TypeInvariant \.{\defeq} channel \.{\in} [ val \.{:} Data ,\, rdy \.{:}
 \{ 0 ,\, 1 \} ,\, ack \.{:} \{ 0 ,\, 1 \} ]}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq} \.{\land} TypeInvariant}%
\@x{\@s{35.70} \.{\land} channel . ack \.{=} channel . rdy}%
\@x{ Send ( d ) \.{\defeq} \.{\land} channel . rdy \.{=} channel . ack}%
 \@x{\@s{54.79} \.{\land} channel \.{'} \.{=} [ channel {\EXCEPT} {\bang} .
 val \.{=} d ,\, {\bang} . rdy \.{=} 1 \.{-} @ ]}%
\@x{ Rcv \.{\defeq} \.{\land} channel . rdy \.{\neq} channel . ack}%
 \@x{\@s{35.94} \.{\land} channel \.{'} \.{=} [ channel {\EXCEPT} {\bang} .
 ack \.{=} 1 \.{-} @ ]}%
 \@x{ Next \.{\defeq} ( \exists\, d \.{\in} Data \.{:} Send ( d ) ) \.{\lor}
 Rcv}%
\@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ channel}}%
\@x{}\midbar\@xx{}%
\@x{ {\THEOREM}\@s{4.1} Spec \.{\implies} {\Box} TypeInvariant}%
\@x{}\bottombar\@xx{}%
\end{document}
