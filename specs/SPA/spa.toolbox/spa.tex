...
\fl{}\moduleLeftDash\cl{ {\MODULE} spa}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Naturals}
\fl{}
\fl{ {\CONSTANT} max\_num\_q}
\fl{}
 \fl{ {\VARIABLE} num ,\, count\_right ,\, count\_wrong ,\, result ,\,
 input\_enabled ,\, check\_enabled ,\, new\_question\_enabled}
\fl{}
 \fl{ vars}\al{7}{1}{ \.{\defeq}}\al{7}{2}{ {\langle} num ,\, count\_right ,\,
 count\_wrong ,\, result ,\, input\_enabled ,\, check\_enabled ,\,
 new\_question\_enabled {\rangle}}
\fl{}
\fl{ Init}\al{9}{1}{ \.{\defeq}}\al{9}{2}{ \.{\land}}\al{9}{3}{ num \.{=} 1}
\fl{ \.{\land}}\al{10}{1}{ count\_right}\al{10}{2}{ \.{=}}\al{10}{3}{ 0}
\fl{ \.{\land}}\al{11}{1}{ count\_wrong}\al{11}{2}{ \.{=}}\al{11}{3}{ 0}
 \fl{ \.{\land}}\al{12}{1}{ input\_enabled}\al{12}{2}{ \.{=}}\al{12}{3}{
 {\TRUE}}
 \fl{ \.{\land}}\al{13}{1}{ check\_enabled}\al{13}{2}{ \.{=}}\al{13}{3}{
 {\FALSE}}
\fl{ \.{\land}}\al{14}{1}{ new\_question\_enabled \.{=} {\FALSE}}
\fl{ \.{\land}}\al{15}{1}{ result \.{=}\@w{}}
\fl{}
 \fl{ Input\_Answer \.{\defeq}}\al{17}{2}{ \.{\land}}\al{17}{3}{
 input\_enabled \.{=} {\TRUE}}
 \fl{ \.{\land}}\al{18}{1}{ input\_enabled \.{'}}\al{18}{3}{ \.{=}}\al{18}{4}{
 {\FALSE}}
 \fl{ \.{\land}}\al{19}{1}{ check\_enabled \.{'}}\al{19}{3}{ \.{=}}\al{19}{4}{
 {\TRUE}}
 \fl{ \.{\land}}\al{20}{1}{ {\UNCHANGED} {\langle} num ,\, count\_right ,\,
 count\_wrong ,\, new\_question\_enabled ,\, result {\rangle}}
\fl{}
 \fl{ Check \.{\defeq}}\al{22}{2}{ \.{\land}}\al{22}{3}{ check\_enabled \.{=}
 {\TRUE}}
\fl{ \.{\land}}\al{23}{1}{ check\_enabled \.{'} \.{=} {\FALSE}}
\fl{ \.{\land}}\al{24}{1}{ new\_question\_enabled \.{'} \.{=} {\TRUE}}
 \fl{ \.{\land}}\al{25}{1}{ \E\, answer\_correct \.{\in} \{ {\TRUE} ,\,
 {\FALSE} \} \.{:}}\al{25}{10}{ {\IF}}\al{25}{11}{ answer\_correct \.{=}
 {\TRUE} \.{\THEN}}
\fl{ \.{\land}}\al{26}{1}{ count\_right \.{'} \.{=} count\_right \.{+} 1}
\fl{ \.{\land}}\al{27}{1}{ result \.{'} \.{=}\@w{Right}}
\fl{ \.{\land}}\al{28}{1}{ {\UNCHANGED} count\_wrong}
 \fl{ \.{\ELSE}}\al{29}{1}{ \.{\land}}\al{29}{2}{ count\_wrong \.{'} \.{=}
 count\_wrong \.{+} 1}
\fl{ \.{\land}}\al{30}{1}{ {\UNCHANGED} count\_right}
\fl{ \.{\land}}\al{31}{1}{ result \.{'} \.{=}\@w{Wrong}}
 \fl{ \.{\land}}\al{32}{1}{ {\UNCHANGED} {\langle} num ,\, input\_enabled
 {\rangle}}
\fl{}
 \fl{ New\_Question \.{\defeq}}\al{34}{2}{ \.{\land}}\al{34}{3}{ num \.{<}
 max\_num\_q}
\fl{ \.{\land}}\al{35}{1}{ new\_question\_enabled \.{=} {\TRUE}}
\fl{ \.{\land}}\al{36}{1}{ new\_question\_enabled \.{'} \.{=} {\FALSE}}
\fl{ \.{\land}}\al{37}{1}{ num \.{'} \.{=} num \.{+} 1}
\fl{ \.{\land}}\al{38}{1}{ input\_enabled \.{'} \.{=} {\TRUE}}
\fl{ \.{\land}}\al{39}{1}{ result \.{'} \.{=}\@w{}}
 \fl{ \.{\land}}\al{40}{1}{ {\UNCHANGED} {\langle} count\_right ,\,
 count\_wrong ,\, check\_enabled {\rangle}}
\fl{}
\fl{}
 \fl{ Terminating \.{\defeq}}\al{43}{2}{ \.{\land}}\al{43}{3}{ num \.{=}
 max\_num\_q}
\fl{ \.{\land}}\al{44}{1}{ {\UNCHANGED} vars}
\fl{}
 \fl{ Next}\al{46}{1}{ \.{\defeq}}\al{46}{2}{ \.{\lor}}\al{46}{3}{
 Input\_Answer}
\fl{ \.{\lor}}\al{47}{1}{ Check}
\fl{ \.{\lor}}\al{48}{1}{ New\_Question}
\fl{ \.{\lor}}\al{49}{1}{ Terminating}
\fl{}
 \fl{ Spec}\al{51}{1}{ \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ vars}
 \.{\land} {\WF}_{ vars} ( Next )}
\fl{}\bottombar\cl{}
\fl{}
\fl{}
